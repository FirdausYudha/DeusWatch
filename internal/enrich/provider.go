...
// NewDemoProvider returns a MockProvider with a few known-"malicious" IPs for the demo.
// Unknown IPs return an EMPTY indicator (no fabricated reputation/country) so a key-less
// deployment never shows fake threat-intel on real traffic - configure an AbuseIPDB/OTX
